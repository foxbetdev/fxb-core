...
This mechanism has been integrated into Bitcore-Node-FXB which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/flitsnode/insight-api-fxb#web-socket-api](https://github.com/flitsnode/insight-api-fxb#web-socket-api) 
* API: [https://github.com/flitsnode/insight-api-fxb#swifttx-transactions](https://github.com/flitsnode/insight-api-fxb#swifttx-transactions) 
...
By default, the FXB Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FXB Core daemon:
