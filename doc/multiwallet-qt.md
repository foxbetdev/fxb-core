...
In order to support loading of multiple wallets in fxb-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fxb.cpp.
...
Changes to fxb.cpp
----------------------
fxb.cpp is the entry point into fxb-qt, and as such, will require some minor modifications to provide hooks for
