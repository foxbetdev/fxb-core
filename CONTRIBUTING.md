Contributing to FXB Core
============================

The FXB Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FXB Core project, and is not to be
confused with overall FXB Network Protocol consensus changes.

Whether a pull request is merged into FXB Core rests with the project merge
...
Patches that change FXB consensus rules are considerably more involved than
...
Where a patch set proposes to change the FXB consensus, it must have been
...
The project leader is the release manager for each FXB Core release.
