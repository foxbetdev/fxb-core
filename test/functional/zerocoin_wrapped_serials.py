...
from fake_stake.base_test import FXB_FakeStakeTest

class zFXBwrappedSerialsTest(FXB_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zFXBs..." % DENOM_TO_USE)
