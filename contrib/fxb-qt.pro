...
RESOURCES += src/qt/fxb.qrc src/qt/fxb_locale.qrc

TRANSLATIONS += src/qt/locale/fxb_bg.ts \
                src/qt/locale/fxb_de.ts \
                src/qt/locale/fxb_en.ts \
                src/qt/locale/fxb_es.ts \
                src/qt/locale/fxb_fi.ts \
                src/qt/locale/fxb_fr.ts \
                src/qt/locale/fxb_it.ts \
                src/qt/locale/fxb_ja.ts \
                src/qt/locale/fxb_pl.ts \
                src/qt/locale/fxb_pt.ts \
                src/qt/locale/fxb_ru.ts \
                src/qt/locale/fxb_sk.ts \
                src/qt/locale/fxb_sv.ts \
                src/qt/locale/fxb_vi.ts \
                src/qt/locale/fxb_zh_CN.ts \
                src/qt/locale/fxb_zh_TW.ts
