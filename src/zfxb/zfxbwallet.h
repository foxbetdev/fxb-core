...
#ifndef FXB_ZFXBWALLET_H
#define FXB_ZFXBWALLET_H
...
public:
    CzFXBWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFXB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFXB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
