...
extern UniValue setzfxbseed(const UniValue& params, bool fHelp);
extern UniValue getzfxbseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfxb(const UniValue& params, bool fHelp);
extern UniValue dzfxbstate(const UniValue& params, bool fHelp);
