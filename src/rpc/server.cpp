...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FXB features */
        {"fxb", "masternode", &masternode, true, true, false},
        {"fxb", "listmasternodes", &listmasternodes, true, true, false},
        {"fxb", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fxb", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fxb", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fxb", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fxb", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fxb", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fxb", "masternodedebug", &masternodedebug, true, true, false},
        {"fxb", "startmasternode", &startmasternode, true, true, false},
        {"fxb", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fxb", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fxb", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fxb", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fxb", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fxb", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fxb", "mnbudget", &mnbudget, true, true, false},
        {"fxb", "preparebudget", &preparebudget, true, true, false},
        {"fxb", "submitbudget", &submitbudget, true, true, false},
        {"fxb", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fxb", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fxb", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fxb", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fxb", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fxb", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fxb", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fxb", "checkbudgets", &checkbudgets, true, true, false},
        {"fxb", "mnsync", &mnsync, true, true, false},
        {"fxb", "spork", &spork, true, true, false},
        {"fxb", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzfxbseed", &getzfxbseed, false, false, true},
        {"zerocoin", "setzfxbseed", &setzfxbseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfxb", &searchdzfxb, false, false, true},
        {"zerocoin", "dzfxbstate", &dzfxbstate, false, false, true},
...
{
    return "> fxb-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61534/\n";
}
