...
/* Fxb GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FXB"
#define QAPP_ORG_DOMAIN "fxb.org"
#define QAPP_APP_NAME_DEFAULT "FXB-Qt"
#define QAPP_APP_NAME_TESTNET "FXB-Qt-testnet"
