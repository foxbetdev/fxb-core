                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFXBPathCustom = GetArg("-zfxbbackuppath", "");
    ...
    if(!strzFXBPathCustom.empty()) {
        ui->wallet_customzfxbbackuppath->setText(QString::fromStdString(strzFXBPathCustom));
        ui->wallet_customzfxbbackuppath_label->setVisible(true);
        ui->wallet_customzfxbbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFXBPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FXB RPC console.") + "<br>" +
